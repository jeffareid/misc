/*----------------------------------------------------------------------*/
/*      msbu4ic.c       hybrid insertion + merge sort + cmp func        */
/*                                                                      */
...
void MergeSort(uint64_t a[], size_t n, CMPFUNC cmp)
{
